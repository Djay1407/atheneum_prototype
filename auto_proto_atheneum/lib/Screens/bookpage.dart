...
import 'package:auto_proto_atheneum/widgets/bookcover.dart';
import 'package:auto_proto_atheneum/widgets/bookpagebook.dart';
import 'package:auto_proto_atheneum/widgets/bookpagescrolleffects.dart';
...
class _EventDetailsPageState extends State<EventDetailsPage> {
  ...
  Widget build(BuildContext context) {
    final content = <Widget>[                   //content is the list of widgets to be shown
    ...
    final backgroundImage = Positioned.fill(
      child: Image.network(
        "https://www.creativindiecovers.com/wp-content/gallery/portfolio/greenweb.jpg",
        fit: BoxFit.cover,
      ),
    );
    ...
    final slivers = CustomScrollView(
      ...
      slivers: [
        SliverList(delegate: SliverChildListDelegate(content)),        //content is the list of widgets 
      ],
    );
...
class _Header extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final moviePoster = Padding(              //movie poster properties
...
class _BackButton extends StatelessWidget {             //back button properties
...
class _EventInfo extends StatelessWidget {
  ...
  List<Widget> _buildTitleAndLengthInMinutes() {
    ...
    return [
      ...
      Text(
        'pages | genres',         //lenght and genres
        style: const TextStyle(
          fontSize: 12.0,
...
class _DirectorInfo extends StatelessWidget {     //director details
